...
<p align="left"> Я занимаюсь разработкой пользовательских интерфейсов(Frontend-разработкой).
Пишу на JavaScript (React, Vue). Мой путь в it начался с образовательной плаьформы GeekBrains  в  2022 году. После изучения основного материала разработки: алгоритмов, Си++, Python, Java, больше всего меня зацепила Frontend разработка!  В настоящий момент двигаюсь в основном это направление, прокачиваю хард скилы и строю свою карьеру в It.</p>
